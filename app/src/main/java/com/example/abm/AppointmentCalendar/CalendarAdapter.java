...
class CalendarAdapter extends RecyclerView.Adapter<CalendarViewHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull CalendarViewHolder holder, int position) {//function fill up the calendar month view (i.e empty cells and not empty cells)
