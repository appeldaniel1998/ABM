...
public class EventEditActivity extends BaseActivity{//} implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        newEventMap.put("appointmentId", eventNew.getAppointmentId());
        newEventMap.put("appointmentType", eventNew.getAppointmentType());
        newEventMap.put("clientId", eventNew.getClientId());
        newEventMap.put("clientName", eventNew.getClientName());
        newEventMap.put("date", eventNew.getDate());
        newEventMap.put("startTime", eventNew.getStartTime());

        DocumentReference docRef=database.collection("Appointments").document(idClientOfAppointment);
        docRef.collection("Client Appointments").document(appointmentID).set(newEventMap).addOnSuccessListener(new OnSuccessListener<Void>() {
